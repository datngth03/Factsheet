...
{
    public abstract class EfCoreTbCompanyBranchRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbCompanyBranch, int>
    {
        public EfCoreTbCompanyBranchRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbCompanyBranch>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? branchName = null,
        ...
        protected virtual IQueryable<TbCompanyBranch> ApplyFilter(
            IQueryable<TbCompanyBranch> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? branchName = null,
