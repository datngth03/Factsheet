...
{
    public abstract class EfCoreTbCompanyBusinessRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbCompanyBusiness, int>
    {
        public EfCoreTbCompanyBusinessRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbCompanyBusiness>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? license = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbCompanyBusinessConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<TbCompanyBusiness> ApplyFilter(
            IQueryable<TbCompanyBusiness> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? license = null,
