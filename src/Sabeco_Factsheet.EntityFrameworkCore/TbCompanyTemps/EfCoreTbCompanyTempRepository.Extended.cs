...
{
    public class EfCoreTbCompanyTempRepository : EfCoreTbCompanyTempRepositoryBase, ITbCompanyTempRepository
    {
        public EfCoreTbCompanyTempRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbCompanyTemp>> GetListNoPagedAsync(
