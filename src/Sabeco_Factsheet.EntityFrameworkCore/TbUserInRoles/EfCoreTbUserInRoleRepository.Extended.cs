...
{
    public class EfCoreTbUserInRoleRepository : EfCoreTbUserInRoleRepositoryBase, ITbUserInRoleRepository
    {
        public EfCoreTbUserInRoleRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbUserInRole>> GetListNoPagedAsync(
