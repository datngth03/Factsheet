...
{
    public abstract class TbBreweryTempUpdateDtoBase : AuditedEntityDto<int>
    {
        [Required(ErrorMessage = "The field is required.")]
        public int idBrewery { get; set; }
        [Required(ErrorMessage = "The field is required.")]
        [StringLength(TbBreweryTempConsts.BreweryCodeMaxLength, ErrorMessage = "The field must be a string with a maximum length of {1}.")] 
        public string BreweryCode { get; set; } = null!;
        [Required(ErrorMessage = "The field is required.")]
        [StringLength(TbBreweryTempConsts.BreweryNameMaxLength, ErrorMessage = "The field must be a string with a maximum length of {1}.")] 
        public string BreweryName { get; set; } = null!;
        [StringLength(TbBreweryTempConsts.BreweryName_ENMaxLength, ErrorMessage = "The field must be a string with a maximum length of {1}.")] 
