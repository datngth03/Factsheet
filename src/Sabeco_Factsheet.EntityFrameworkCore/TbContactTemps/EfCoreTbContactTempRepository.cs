...
{
    public abstract class EfCoreTbContactTempRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbContactTemp, int>
    {
        public EfCoreTbContactTempRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbContactTemp>> GetListAsync(
            string? filterText = null,
            int? companyidMin = null,
            int? companyidMax = null,
            string? contactName = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbContactTempConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<TbContactTemp> ApplyFilter(
            IQueryable<TbContactTemp> query,
            string? filterText = null,
            int? companyidMin = null,
            int? companyidMax = null,
            string? contactName = null,
