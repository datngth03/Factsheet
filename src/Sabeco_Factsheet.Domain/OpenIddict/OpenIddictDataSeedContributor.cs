...
namespace Sabeco_Factsheet.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("Sabeco_Factsheet") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "Sabeco_Factsheet", DisplayName = "Sabeco_Factsheet API", Resources = { "Sabeco_Factsheet" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["Sabeco_Factsheet_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["Sabeco_Factsheet_Swagger:RootUrl"]?.TrimEnd('/');
