...
{
    public class EfCoreTbCompanyBranchTempRepository : EfCoreTbCompanyBranchTempRepositoryBase, ITbCompanyBranchTempRepository
    {
        public EfCoreTbCompanyBranchTempRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbCompanyBranchTemp>> GetListNoPagedAsync(
