...
namespace Sabeco_Factsheet.EntityFrameworkCore.Domains.TbContacts
{
    public class TbContactRepositoryTests : Sabeco_FactsheetEntityFrameworkCoreTestBase
    {
        private readonly ITbContactRepository _tbContactRepository;

        public TbContactRepositoryTests()
        {
            _tbContactRepository = GetRequiredService<ITbContactRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tbContactRepository.GetListAsync(
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tbContactRepository.GetCountAsync(
