...
{
    public abstract class EfCoreTbCompanyBusinessDetailRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbCompanyBusinessDetail, int>
    {
        public EfCoreTbCompanyBusinessDetailRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbCompanyBusinessDetail>> GetListAsync(
            string? filterText = null,
            int? parentIdMin = null,
            int? parentIdMax = null,
            string? registrationCode = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbCompanyBusinessDetailConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<TbCompanyBusinessDetail> ApplyFilter(
            IQueryable<TbCompanyBusinessDetail> query,
            string? filterText = null,
            int? parentIdMin = null,
            int? parentIdMax = null,
            string? registrationCode = null,
