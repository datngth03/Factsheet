...
{
    public abstract class EfCoreTsClassRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TsClass, int>
    {
        public EfCoreTsClassRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TsClass>> GetListAsync(
            string? filterText = null,
            string? parentCode = null,
            string? code = null,
            string? name = null,
        ...
        protected virtual IQueryable<TsClass> ApplyFilter(
            IQueryable<TsClass> query,
            string? filterText = null,
            string? parentCode = null,
            string? code = null,
            string? name = null,
