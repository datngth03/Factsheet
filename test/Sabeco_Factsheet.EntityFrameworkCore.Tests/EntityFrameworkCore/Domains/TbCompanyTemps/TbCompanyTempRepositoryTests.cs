...
namespace Sabeco_Factsheet.EntityFrameworkCore.Domains.TbCompanyTemps
{
    public class TbCompanyTempRepositoryTests : Sabeco_FactsheetEntityFrameworkCoreTestBase
    {
        private readonly ITbCompanyTempRepository _tbCompanyTempRepository;

        public TbCompanyTempRepositoryTests()
        {
            _tbCompanyTempRepository = GetRequiredService<ITbCompanyTempRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tbCompanyTempRepository.GetListAsync(
                    isGroup: true,
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tbCompanyTempRepository.GetCountAsync(
                    isGroup: true,
