...
namespace Sabeco_Factsheet.EntityFrameworkCore.Domains.TbBreweryTemps
{
    public class TbBreweryTempRepositoryTests : Sabeco_FactsheetEntityFrameworkCoreTestBase
    {
        private readonly ITbBreweryTempRepository _tbBreweryTempRepository;

        public TbBreweryTempRepositoryTests()
        {
            _tbBreweryTempRepository = GetRequiredService<ITbBreweryTempRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tbBreweryTempRepository.GetListAsync(
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tbBreweryTempRepository.GetCountAsync(
