...
{
    public abstract class TbCompanyMappingTempBase : Entity<int>
    {
        ...
        protected TbCompanyMappingTempBase()
        {

        }

        public TbCompanyMappingTempBase(int? companyId = null, string? companyTypeShareholdingCode = null, string? companyTypesCode = null, string? note = null, DateTime? crt_date = null, int? crt_user = null, DateTime? mod_date = null, int? mod_user = null, int? idCompanyTypeShareholdingCode = null, int? idCompanyTypesCode = null)
        {
