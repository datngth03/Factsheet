...
{
    public abstract class EfCoreTbCompanyMappingRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbCompanyMapping, int>
    {
        public EfCoreTbCompanyMappingRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbCompanyMapping>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? companyTypeShareholdingCode = null,
        ...
        protected virtual IQueryable<TbCompanyMapping> ApplyFilter(
            IQueryable<TbCompanyMapping> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? companyTypeShareholdingCode = null,
