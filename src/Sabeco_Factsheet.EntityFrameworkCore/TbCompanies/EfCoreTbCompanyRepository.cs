...
{
    public abstract class EfCoreTbCompanyRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbCompany, int>
    {
        public EfCoreTbCompanyRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task DeleteAllAsync(
            ...
            string? bravoCode = null,
            string? legacyCode = null,
            int? idCompanyTypeMin = null,
            int? idCompanyTypeMax = null,
            bool? IsDeleted = null,
        ...
        public virtual async Task<List<TbCompany>> GetListAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var query = ApplyFilter((await GetQueryableAsync()), filterText, parentIdMin, parentIdMax, isGroup, code, name, name_EN, briefName, contactInfo_01, contactInfo_02, contactInfo_03, contactInfo_04, contactInfo_05, contactInfo_06, stockCode, stockExchange, stockRegistrationDateMin, stockRegistrationDateMax, isPublicCompany, licenseNo, license, registrationOrderMin, registrationOrderMax, registrationDate0Min, registrationDate0Max, registrationDateMin, registrationDateMax, latestAmendmentMin, latestAmendmentMax, legalRepresent, companyType, charteredCapitalMin, charteredCapitalMax, totalShareMin, totalShareMax, listedShareMin, listedShareMax, parValueMin, parValueMax, contactName1, contactDept1, contactMail1, contactPosition1, contactPhone1, contactName2, contactDept2, contactMail2, contactPosition2, contactPhone2, longtitudeMin, longtitudeMax, latitudeMin, latitudeMax, note, docStatusMin, docStatusMax, directShareholdingMin, directShareholdingMax, consolidatedShareholdingMin, consolidatedShareholdingMax, consolidateNoted, votingRightDirectMin, votingRightDirectMax, votingRightTotalMin, votingRightTotalMax, image, isActive, crt_dateMin, crt_dateMax, crt_userMin, crt_userMax, mod_dateMin, mod_dateMax, mod_userMin, mod_userMax, bravoCode, legacyCode, idCompanyTypeMin, idCompanyTypeMax, IsDeleted);
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbCompanyConsts.GetDefaultSorting(false) : sorting);
        ...
        public virtual async Task<long> GetCountAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var query = ApplyFilter((await GetDbSetAsync()), filterText, parentIdMin, parentIdMax, isGroup, code, name, name_EN, briefName, contactInfo_01, contactInfo_02, contactInfo_03, contactInfo_04, contactInfo_05, contactInfo_06, stockCode, stockExchange, stockRegistrationDateMin, stockRegistrationDateMax, isPublicCompany, licenseNo, license, registrationOrderMin, registrationOrderMax, registrationDate0Min, registrationDate0Max, registrationDateMin, registrationDateMax, latestAmendmentMin, latestAmendmentMax, legalRepresent, companyType, charteredCapitalMin, charteredCapitalMax, totalShareMin, totalShareMax, listedShareMin, listedShareMax, parValueMin, parValueMax, contactName1, contactDept1, contactMail1, contactPosition1, contactPhone1, contactName2, contactDept2, contactMail2, contactPosition2, contactPhone2, longtitudeMin, longtitudeMax, latitudeMin, latitudeMax, note, docStatusMin, docStatusMax, directShareholdingMin, directShareholdingMax, consolidatedShareholdingMin, consolidatedShareholdingMax, consolidateNoted, votingRightDirectMin, votingRightDirectMax, votingRightTotalMin, votingRightTotalMax, image, isActive, crt_dateMin, crt_dateMax, crt_userMin, crt_userMax, mod_dateMin, mod_dateMax, mod_userMin, mod_userMax, bravoCode, legacyCode, idCompanyTypeMin, idCompanyTypeMax, IsDeleted);
            return await query.LongCountAsync(GetCancellationToken(cancellationToken));
        }

        protected virtual IQueryable<TbCompany> ApplyFilter(
            IQueryable<TbCompany> query,
            string? filterText = null,
            int? parentIdMin = null,
            int? parentIdMax = null,
            bool? isGroup = null,
            ...
            bool? IsDeleted = null)
        {
            return query
                    ...
                    .WhereIf(!string.IsNullOrWhiteSpace(bravoCode), e => e.BravoCode.ToLower().Contains(bravoCode.ToLower()))
                    .WhereIf(!string.IsNullOrWhiteSpace(legacyCode), e => e.LegacyCode.ToLower().Contains(legacyCode.ToLower()))
                    .WhereIf(idCompanyTypeMin.HasValue, e => e.idCompanyType >= idCompanyTypeMin!.Value)
                    .WhereIf(idCompanyTypeMax.HasValue, e => e.idCompanyType <= idCompanyTypeMax!.Value)
