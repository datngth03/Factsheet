...
{
    public abstract class TbFileUploadTempBase : Entity<int>
    {
        ...
        protected TbFileUploadTempBase()
        {

        }

        public TbFileUploadTempBase(int downloadCount, int? companyId = null, int? personId = null, string? fileName = null, string? fullFileName = null, string? fileLink = null, DateTime? uploadDate = null, int? userUpload = null, string? note = null, bool? isActive = null, DateTime? crt_date = null, int? crt_user = null, DateTime? mod_date = null, int? mod_user = null)
        {
