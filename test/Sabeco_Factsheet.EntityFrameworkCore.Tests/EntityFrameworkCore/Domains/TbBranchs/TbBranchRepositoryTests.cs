...
namespace Sabeco_Factsheet.EntityFrameworkCore.Domains.TbBranchs
{
    public class TbBranchRepositoryTests : Sabeco_FactsheetEntityFrameworkCoreTestBase
    {
        private readonly ITbBranchRepository _tbBranchRepository;

        public TbBranchRepositoryTests()
        {
            _tbBranchRepository = GetRequiredService<ITbBranchRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tbBranchRepository.GetListAsync(
                    code: "e09ebdc8ab",
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tbBranchRepository.GetCountAsync(
                    code: "9d22ca9234",
