...
{
    public class TbAssetsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ITbAssetRepository _tbAssetRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public TbAssetsDataSeedContributor(ITbAssetRepository tbAssetRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _tbAssetRepository.InsertAsync(new TbAsset
            (
                companyId: 373103855,
                ...
                docDate: new DateTime(2010, 11, 10),
                expireDate: new DateTime(2009, 1, 18),
            ...
            (
                ...
                docDate: new DateTime(2019, 3, 9),
                expireDate: new DateTime(2003, 4, 3),
