...
{
    public class EfCoreTbAdditionInfoRepository : EfCoreTbAdditionInfoRepositoryBase, ITbAdditionInfoRepository
    {
        public EfCoreTbAdditionInfoRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbAdditionInfo>> GetListNoPagedAsync(
