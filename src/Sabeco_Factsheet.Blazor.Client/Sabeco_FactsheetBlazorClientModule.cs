...
using Sabeco_Factsheet.Blazor.Client.Components.Layout;
...
[DependsOn(
    ...
    typeof(Sabeco_FactsheetHttpApiClientModule),
    typeof(SaasHostBlazorWebAssemblyModule),
    typeof(TextTemplateManagementBlazorWebAssemblyModule) 
)]
public class Sabeco_FactsheetBlazorClientModule : AbpModule
{
    ...
    private void ConfigureRouter(ServiceConfigurationContext context)
    {
        ...
        {
            options.AppAssembly = typeof(Sabeco_FactsheetBlazorClientModule).Assembly;
    ...
    private void ConfigureAutoMapper(ServiceConfigurationContext context)
    {
        ...
        {
            options.AddMaps<Sabeco_FactsheetBlazorClientModule>();
        });
    }
}
