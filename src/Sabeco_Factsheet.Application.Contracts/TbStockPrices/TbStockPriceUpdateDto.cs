...
{
    public abstract class TbStockPriceUpdateDtoBase : AuditedEntityDto<int>
    {
        [Required(ErrorMessage = "The field is required.")]
        [StringLength(TbStockPriceConsts.StockCodeMaxLength, ErrorMessage = "The field must be a string with a maximum length of {1}.")] 
