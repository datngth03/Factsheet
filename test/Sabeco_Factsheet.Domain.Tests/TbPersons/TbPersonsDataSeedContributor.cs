...
{
    public class TbPersonsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ITbPersonRepository _tbPersonRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public TbPersonsDataSeedContributor(ITbPersonRepository tbPersonRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _tbPersonRepository.InsertAsync(new TbPerson
            (
                code: "090b963dc3d34f5ca50b",
                companyId: 2043900556,
                ...
                iDCardDate: new DateTime(2007, 10, 2),
            ...
            (
                ...
                iDCardDate: new DateTime(2015, 6, 1),
