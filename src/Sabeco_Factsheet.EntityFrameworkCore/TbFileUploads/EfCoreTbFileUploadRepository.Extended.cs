...
{
    public class EfCoreTbFileUploadRepository : EfCoreTbFileUploadRepositoryBase, ITbFileUploadRepository
    {
        public EfCoreTbFileUploadRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbFileUpload>> GetListNoPagedAsync(
