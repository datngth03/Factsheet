...
{
    public abstract class TbCompanyStockTempBase : Entity<int>
    {
        ...
        protected TbCompanyStockTempBase()
        {

        }

        public TbCompanyStockTempBase(int companyId, string companyCode, bool isPublicCompany, bool isActive, string? stockExchange = null, DateTime? registrationDate = null, decimal? charteredCapital = null, decimal? parValue = null, int? totalShare = null, int? listedShare = null, string? description = null, DateTime? crt_date = null, int? crt_user = null)
        {

            Check.NotNull(companyCode, nameof(companyCode));
            Check.Length(companyCode, nameof(companyCode), TbCompanyStockTempConsts.CompanyCodeMaxLength, 0);
            Check.Length(stockExchange, nameof(stockExchange), TbCompanyStockTempConsts.StockExchangeMaxLength, 0);
            Check.Length(description, nameof(description), TbCompanyStockTempConsts.DescriptionMaxLength, 0);
            CompanyId = companyId;
