...
{
    public abstract class EfCoreTbCompanyMajorRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbCompanyMajor, int>
    {
        public EfCoreTbCompanyMajorRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbCompanyMajor>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? shareHolderMajor = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbCompanyMajorConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<TbCompanyMajor> ApplyFilter(
            IQueryable<TbCompanyMajor> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? shareHolderMajor = null,
