...
{
    public abstract class TbCompanyMajorBase : Entity<int>
    {
        ...
        protected TbCompanyMajorBase()
        {

        }

        public TbCompanyMajorBase(int companyId, string shareHolderMajor, string shareHolderType, bool isActive, bool isDeleted, DateTime? fromDate = null, DateTime? toDate = null, decimal? shareHolderValue = null, decimal? shareHolderRate = null, string? note = null, DateTime? crt_date = null, int? crt_user = null, DateTime? mod_date = null, int? mod_user = null, int? classId = null)
        {

            Check.NotNull(shareHolderMajor, nameof(shareHolderMajor));
            Check.NotNull(shareHolderType, nameof(shareHolderType));
            Check.Length(shareHolderType, nameof(shareHolderType), TbCompanyMajorConsts.ShareHolderTypeMaxLength, 0);
            Check.Length(note, nameof(note), TbCompanyMajorConsts.NoteMaxLength, 0);
            CompanyId = companyId;
