...
{
    public abstract class EfCoreTbCompanyStockTempRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbCompanyStockTemp, int>
    {
        public EfCoreTbCompanyStockTempRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbCompanyStockTemp>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? companyCode = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbCompanyStockTempConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<TbCompanyStockTemp> ApplyFilter(
            IQueryable<TbCompanyStockTemp> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? companyCode = null,
