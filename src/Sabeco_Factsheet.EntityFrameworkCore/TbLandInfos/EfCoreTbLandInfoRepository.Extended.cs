...
{
    public class EfCoreTbLandInfoRepository : EfCoreTbLandInfoRepositoryBase, ITbLandInfoRepository
    {
        public EfCoreTbLandInfoRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbLandInfo>> GetListNoPagedAsync(
