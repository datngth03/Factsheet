...
{
    public abstract class TbCompanyMajorUpdateDtoBase : AuditedEntityDto<int>
    {
        ...
        [Required(ErrorMessage = "The field is required.")]
        [StringLength(TbCompanyMajorConsts.ShareHolderTypeMaxLength, ErrorMessage = "The field must be a string with a maximum length of {1}.")] 
        ...
        [StringLength(TbCompanyMajorConsts.NoteMaxLength, ErrorMessage = "The field must be a string with a maximum length of {1}.")] 
