...
{
    public abstract class TbCompanyTempBase : Entity<int>
    {
        ...
        protected TbCompanyTempBase()
        {

        }

        public TbCompanyTempBase(int idCompany, int parentId, bool isGroup, string code, string name, string? name_EN = null, string? briefName = null, string? contactInfo_01 = null, string? contactInfo_02 = null, string? contactInfo_03 = null, string? contactInfo_04 = null, string? contactInfo_05 = null, string? contactInfo_06 = null, string? stockCode = null, string? stockExchange = null, DateTime? stockRegistrationDate = null, bool? isPublicCompany = null, string? licenseNo = null, string? license = null, byte? registrationOrder = null, DateTime? registrationDate0 = null, DateTime? registrationDate = null, DateTime? latestAmendment = null, string? legalRepresent = null, string? companyType = null, decimal? charteredCapital = null, decimal? totalShare = null, decimal? listedShare = null, int? parValue = null, string? contactName1 = null, string? contactDept1 = null, string? contactMail1 = null, string? contactPosition1 = null, string? contactPhone1 = null, string? contactName2 = null, string? contactDept2 = null, string? contactMail2 = null, string? contactPosition2 = null, string? contactPhone2 = null, double? longtitude = null, double? latitude = null, string? note = null, byte? docStatus = null, decimal? directShareholding = null, decimal? consolidatedShareholding = null, string? consolidateNoted = null, decimal? votingRightDirect = null, decimal? votingRightTotal = null, string? image = null, bool? isActive = null, DateTime? crt_date = null, int? crt_user = null, DateTime? mod_date = null, int? mod_user = null, string? bravoCode = null, string? legacyCode = null)
        {

            Check.NotNull(code, nameof(code));
            Check.Length(code, nameof(code), TbCompanyTempConsts.CodeMaxLength, 0);
            Check.NotNull(name, nameof(name));
            Check.Length(name, nameof(name), TbCompanyTempConsts.NameMaxLength, 0);
            Check.Length(name_EN, nameof(name_EN), TbCompanyTempConsts.Name_ENMaxLength, 0);
            Check.Length(briefName, nameof(briefName), TbCompanyTempConsts.BriefNameMaxLength, 0);
            Check.Length(contactInfo_01, nameof(contactInfo_01), TbCompanyTempConsts.ContactInfo_01MaxLength, 0);
            Check.Length(contactInfo_02, nameof(contactInfo_02), TbCompanyTempConsts.ContactInfo_02MaxLength, 0);
            Check.Length(contactInfo_03, nameof(contactInfo_03), TbCompanyTempConsts.ContactInfo_03MaxLength, 0);
            Check.Length(contactInfo_04, nameof(contactInfo_04), TbCompanyTempConsts.ContactInfo_04MaxLength, 0);
            Check.Length(contactInfo_05, nameof(contactInfo_05), TbCompanyTempConsts.ContactInfo_05MaxLength, 0);
            Check.Length(contactInfo_06, nameof(contactInfo_06), TbCompanyTempConsts.ContactInfo_06MaxLength, 0);
            Check.Length(stockCode, nameof(stockCode), TbCompanyTempConsts.StockCodeMaxLength, 0);
            Check.Length(stockExchange, nameof(stockExchange), TbCompanyTempConsts.StockExchangeMaxLength, 0);
            Check.Length(licenseNo, nameof(licenseNo), TbCompanyTempConsts.LicenseNoMaxLength, 0);
            Check.Length(license, nameof(license), TbCompanyTempConsts.LicenseMaxLength, 0);
            Check.Length(legalRepresent, nameof(legalRepresent), TbCompanyTempConsts.LegalRepresentMaxLength, 0);
            Check.Length(companyType, nameof(companyType), TbCompanyTempConsts.CompanyTypeMaxLength, 0);
            Check.Length(contactName1, nameof(contactName1), TbCompanyTempConsts.ContactName1MaxLength, 0);
            Check.Length(contactDept1, nameof(contactDept1), TbCompanyTempConsts.ContactDept1MaxLength, 0);
            Check.Length(contactMail1, nameof(contactMail1), TbCompanyTempConsts.ContactMail1MaxLength, 0);
            Check.Length(contactPosition1, nameof(contactPosition1), TbCompanyTempConsts.ContactPosition1MaxLength, 0);
            Check.Length(contactPhone1, nameof(contactPhone1), TbCompanyTempConsts.ContactPhone1MaxLength, 0);
            Check.Length(contactName2, nameof(contactName2), TbCompanyTempConsts.ContactName2MaxLength, 0);
            Check.Length(contactDept2, nameof(contactDept2), TbCompanyTempConsts.ContactDept2MaxLength, 0);
            Check.Length(contactMail2, nameof(contactMail2), TbCompanyTempConsts.ContactMail2MaxLength, 0);
            Check.Length(contactPosition2, nameof(contactPosition2), TbCompanyTempConsts.ContactPosition2MaxLength, 0);
            Check.Length(contactPhone2, nameof(contactPhone2), TbCompanyTempConsts.ContactPhone2MaxLength, 0);
            Check.Length(note, nameof(note), TbCompanyTempConsts.NoteMaxLength, 0);
            Check.Length(bravoCode, nameof(bravoCode), TbCompanyTempConsts.BravoCodeMaxLength, 0);
            Check.Length(legacyCode, nameof(legacyCode), TbCompanyTempConsts.LegacyCodeMaxLength, 0);
