...
{
    public abstract class EfCoreTbLandInfoTempRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbLandInfoTemp, int>
    {
        public EfCoreTbLandInfoTempRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbLandInfoTemp>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? description = null,
        ...
        protected virtual IQueryable<TbLandInfoTemp> ApplyFilter(
            IQueryable<TbLandInfoTemp> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            string? description = null,
