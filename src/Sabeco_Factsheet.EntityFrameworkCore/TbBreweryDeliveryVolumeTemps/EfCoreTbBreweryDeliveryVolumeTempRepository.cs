...
{
    public abstract class EfCoreTbBreweryDeliveryVolumeTempRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbBreweryDeliveryVolumeTemp, int>
    {
        public EfCoreTbBreweryDeliveryVolumeTempRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = ApplyFilter(query, filterText, idBreweryDeliveryVolumeMin, idBreweryDeliveryVolumeMax, breweryIdMin, breweryIdMax, breweryCode, yearMin, yearMax, deliveryVolumeMin, deliveryVolumeMax, isActive, create_userMin, create_userMax, create_dateMin, create_dateMax, mod_userMin, mod_userMax, mod_dateMin, mod_dateMax);

            var ids = query.Select(x => x.Id);
            await DeleteManyAsync(ids, cancellationToken: GetCancellationToken(cancellationToken));
        }

        public virtual async Task<List<TbBreweryDeliveryVolumeTemp>> GetListAsync(
            string? filterText = null,
            int? idBreweryDeliveryVolumeMin = null,
            int? idBreweryDeliveryVolumeMax = null,
            int? breweryIdMin = null,
        ...
        public virtual async Task<long> GetCountAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var query = ApplyFilter((await GetDbSetAsync()), filterText, idBreweryDeliveryVolumeMin, idBreweryDeliveryVolumeMax, breweryIdMin, breweryIdMax, breweryCode, yearMin, yearMax, deliveryVolumeMin, deliveryVolumeMax, isActive, create_userMin, create_userMax, create_dateMin, create_dateMax, mod_userMin, mod_userMax, mod_dateMin, mod_dateMax);
            return await query.LongCountAsync(GetCancellationToken(cancellationToken));
        }

        protected virtual IQueryable<TbBreweryDeliveryVolumeTemp> ApplyFilter(
            IQueryable<TbBreweryDeliveryVolumeTemp> query,
            string? filterText = null,
            int? idBreweryDeliveryVolumeMin = null,
            int? idBreweryDeliveryVolumeMax = null,
            int? breweryIdMin = null,
            ...
            DateTime? mod_dateMax = null)
        {
            return query
                    ...
                    .WhereIf(idBreweryDeliveryVolumeMin.HasValue, e => e.idBreweryDeliveryVolume >= idBreweryDeliveryVolumeMin!.Value)
                    .WhereIf(idBreweryDeliveryVolumeMax.HasValue, e => e.idBreweryDeliveryVolume <= idBreweryDeliveryVolumeMax!.Value)
