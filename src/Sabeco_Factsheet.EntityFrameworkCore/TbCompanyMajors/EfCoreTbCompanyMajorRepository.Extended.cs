...
{
    public class EfCoreTbCompanyMajorRepository : EfCoreTbCompanyMajorRepositoryBase, ITbCompanyMajorRepository
    {
        public EfCoreTbCompanyMajorRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbCompanyMajor>> GetListNoPagedAsync(
