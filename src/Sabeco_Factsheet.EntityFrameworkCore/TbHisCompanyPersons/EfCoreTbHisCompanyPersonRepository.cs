...
{
    public abstract class EfCoreTbHisCompanyPersonRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbHisCompanyPerson, int>
    {
        public EfCoreTbHisCompanyPersonRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbHisCompanyPerson>> GetListAsync(
            string? filterText = null,
            bool? isSendMail = null,
            DateTime? dateSendMailMin = null,
            DateTime? dateSendMailMax = null,
        ...
        protected virtual IQueryable<TbHisCompanyPerson> ApplyFilter(
            IQueryable<TbHisCompanyPerson> query,
            string? filterText = null,
            bool? isSendMail = null,
            DateTime? dateSendMailMin = null,
            DateTime? dateSendMailMax = null,
