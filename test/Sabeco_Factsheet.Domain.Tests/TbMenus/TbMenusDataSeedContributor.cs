...
{
    public class TbMenusDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ITbMenuRepository _tbMenuRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public TbMenusDataSeedContributor(ITbMenuRepository tbMenuRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _tbMenuRepository.InsertAsync(new TbMenu
            (
