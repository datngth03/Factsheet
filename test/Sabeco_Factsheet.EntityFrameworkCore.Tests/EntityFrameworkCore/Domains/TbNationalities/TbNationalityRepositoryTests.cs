...
namespace Sabeco_Factsheet.EntityFrameworkCore.Domains.TbNationalities
{
    public class TbNationalityRepositoryTests : Sabeco_FactsheetEntityFrameworkCoreTestBase
    {
        private readonly ITbNationalityRepository _tbNationalityRepository;

        public TbNationalityRepositoryTests()
        {
            _tbNationalityRepository = GetRequiredService<ITbNationalityRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tbNationalityRepository.GetListAsync(
                    code: "8a3",
                    code2: "98",
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tbNationalityRepository.GetCountAsync(
                    code: "467",
                    code2: "f4",
