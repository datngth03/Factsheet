...
{
    public abstract class EfCoreTbNationalityTempRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbNationalityTemp, int>
    {
        public EfCoreTbNationalityTempRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbNationalityTemp>> GetListAsync(
            string? filterText = null,
            string? code = null,
            string? code2 = null,
            string? name_en = null,
        ...
        protected virtual IQueryable<TbNationalityTemp> ApplyFilter(
            IQueryable<TbNationalityTemp> query,
            string? filterText = null,
            string? code = null,
            string? code2 = null,
            string? name_en = null,
