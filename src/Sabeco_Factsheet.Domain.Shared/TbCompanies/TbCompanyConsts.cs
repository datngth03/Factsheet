...
{
    public static class TbCompanyConsts
    {
        private const string DefaultSorting = "{0}ParentId asc";

        public static string GetDefaultSorting(bool withEntityName)
        {
            return string.Format(DefaultSorting, withEntityName ? "TbCompany." : string.Empty);
        }
        ...
        public const int BravoCodeMaxLength = 5;
        public const int LegacyCodeMaxLength = 16;
        public const byte RegistrationOrderMinLength = 0;
        public const byte RegistrationOrderMaxLength = 255;
    }
}