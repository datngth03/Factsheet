...
{
    public class EfCoreTbContactTempRepository : EfCoreTbContactTempRepositoryBase, ITbContactTempRepository
    {
        public EfCoreTbContactTempRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbContactTemp>> GetListNoPagedAsync(
