...
namespace Sabeco_Factsheet.EntityFrameworkCore.Domains.TbCompanyBusinesses
{
    public class TbCompanyBusinessRepositoryTests : Sabeco_FactsheetEntityFrameworkCoreTestBase
    {
        private readonly ITbCompanyBusinessRepository _tbCompanyBusinessRepository;

        public TbCompanyBusinessRepositoryTests()
        {
            _tbCompanyBusinessRepository = GetRequiredService<ITbCompanyBusinessRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tbCompanyBusinessRepository.GetListAsync(
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tbCompanyBusinessRepository.GetCountAsync(
