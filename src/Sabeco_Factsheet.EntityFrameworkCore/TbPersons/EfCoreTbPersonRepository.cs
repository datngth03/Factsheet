...
{
    public abstract class EfCoreTbPersonRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbPerson, int>
    {
        public EfCoreTbPersonRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = ApplyFilter(query, filterText, code, companyIdMin, companyIdMax, fullName, birthDateMin, birthDateMax, birthPlace, address, iDCardNo, iDCardDateMin, iDCardDateMax, idCardIssuePlace, ethnicity, religion, nationalityCode, gender, phone, email, note, image, isActive, docStatusMin, docStatusMax, isCheckRetirement, isCheckTermEnd, crt_dateMin, crt_dateMax, crt_userMin, crt_userMax, mod_dateMin, mod_dateMax, mod_userMin, mod_userMax, oldCode, isDeleted);

            var ids = query.Select(x => x.Id);
            await DeleteManyAsync(ids, cancellationToken: GetCancellationToken(cancellationToken));
        }

        public virtual async Task<List<TbPerson>> GetListAsync(
            string? filterText = null,
            string? code = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
        ...
        public virtual async Task<long> GetCountAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var query = ApplyFilter((await GetDbSetAsync()), filterText, code, companyIdMin, companyIdMax, fullName, birthDateMin, birthDateMax, birthPlace, address, iDCardNo, iDCardDateMin, iDCardDateMax, idCardIssuePlace, ethnicity, religion, nationalityCode, gender, phone, email, note, image, isActive, docStatusMin, docStatusMax, isCheckRetirement, isCheckTermEnd, crt_dateMin, crt_dateMax, crt_userMin, crt_userMax, mod_dateMin, mod_dateMax, mod_userMin, mod_userMax, oldCode, isDeleted);
            return await query.LongCountAsync(GetCancellationToken(cancellationToken));
        }

        protected virtual IQueryable<TbPerson> ApplyFilter(
            IQueryable<TbPerson> query,
            string? filterText = null,
            string? code = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
