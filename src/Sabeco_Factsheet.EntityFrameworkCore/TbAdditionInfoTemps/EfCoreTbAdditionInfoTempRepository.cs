...
{
    public abstract class EfCoreTbAdditionInfoTempRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbAdditionInfoTemp, int>
    {
        public EfCoreTbAdditionInfoTempRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbAdditionInfoTemp>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            DateTime? docDateMin = null,
        ...
        protected virtual IQueryable<TbAdditionInfoTemp> ApplyFilter(
            IQueryable<TbAdditionInfoTemp> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            DateTime? docDateMin = null,
