...
{
    public class EfCoreTbCompanyStockTempRepository : EfCoreTbCompanyStockTempRepositoryBase, ITbCompanyStockTempRepository
    {
        public EfCoreTbCompanyStockTempRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbCompanyStockTemp>> GetListNoPagedAsync(
