...
{
    public partial interface ITbHisBreweryDeliveryVolumeRepository : IRepository<TbHisBreweryDeliveryVolume, int>
    {
        ...
        Task<List<TbHisBreweryDeliveryVolume>> GetListAsync(
                    string? filterText = null,
                    bool? isSendMail = null,
                    DateTime? dateSendMailMin = null,
                    DateTime? dateSendMailMax = null,
