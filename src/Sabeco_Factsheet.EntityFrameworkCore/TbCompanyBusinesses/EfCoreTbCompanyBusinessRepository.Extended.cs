...
{
    public class EfCoreTbCompanyBusinessRepository : EfCoreTbCompanyBusinessRepositoryBase, ITbCompanyBusinessRepository
    {
        public EfCoreTbCompanyBusinessRepository(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            : base(dbContextProvider)
        {
        }
        //HQSOFT's generated code:
        public virtual async Task<List<TbCompanyBusiness>> GetListNoPagedAsync(
