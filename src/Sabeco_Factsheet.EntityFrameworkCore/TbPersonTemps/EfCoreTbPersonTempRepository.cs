...
{
    public abstract class EfCoreTbPersonTempRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbPersonTemp, int>
    {
        public EfCoreTbPersonTempRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = ApplyFilter(query, filterText, idPersonMin, idPersonMax, code, companyIdMin, companyIdMax, fullName, birthDateMin, birthDateMax, birthPlace, address, iDCardNo, iDCardDateMin, iDCardDateMax, idCardIssuePlace, ethnicity, religion, nationalityCode, gender, phone, email, note, image, isActive, docStatusMin, docStatusMax, isCheckRetirement, isCheckTermEnd, crt_dateMin, crt_dateMax, crt_userMin, crt_userMax, mod_dateMin, mod_dateMax, mod_userMin, mod_userMax, oldCode);

            var ids = query.Select(x => x.Id);
            await DeleteManyAsync(ids, cancellationToken: GetCancellationToken(cancellationToken));
        }

        public virtual async Task<List<TbPersonTemp>> GetListAsync(
            string? filterText = null,
            int? idPersonMin = null,
            int? idPersonMax = null,
            string? code = null,
            ...
            CancellationToken cancellationToken = default)
        {
            var query = ApplyFilter((await GetQueryableAsync()), filterText, idPersonMin, idPersonMax, code, companyIdMin, companyIdMax, fullName, birthDateMin, birthDateMax, birthPlace, address, iDCardNo, iDCardDateMin, iDCardDateMax, idCardIssuePlace, ethnicity, religion, nationalityCode, gender, phone, email, note, image, isActive, docStatusMin, docStatusMax, isCheckRetirement, isCheckTermEnd, crt_dateMin, crt_dateMax, crt_userMin, crt_userMax, mod_dateMin, mod_dateMax, mod_userMin, mod_userMax, oldCode);
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbPersonTempConsts.GetDefaultSorting(false) : sorting);
        ...
        public virtual async Task<long> GetCountAsync(
            ...
            CancellationToken cancellationToken = default)
        {
            var query = ApplyFilter((await GetDbSetAsync()), filterText, idPersonMin, idPersonMax, code, companyIdMin, companyIdMax, fullName, birthDateMin, birthDateMax, birthPlace, address, iDCardNo, iDCardDateMin, iDCardDateMax, idCardIssuePlace, ethnicity, religion, nationalityCode, gender, phone, email, note, image, isActive, docStatusMin, docStatusMax, isCheckRetirement, isCheckTermEnd, crt_dateMin, crt_dateMax, crt_userMin, crt_userMax, mod_dateMin, mod_dateMax, mod_userMin, mod_userMax, oldCode);
            return await query.LongCountAsync(GetCancellationToken(cancellationToken));
        }

        protected virtual IQueryable<TbPersonTemp> ApplyFilter(
            IQueryable<TbPersonTemp> query,
            string? filterText = null,
            int? idPersonMin = null,
            int? idPersonMax = null,
            string? code = null,
