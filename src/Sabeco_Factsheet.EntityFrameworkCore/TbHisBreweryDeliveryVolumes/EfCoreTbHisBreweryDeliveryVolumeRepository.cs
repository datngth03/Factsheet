...
{
    public abstract class EfCoreTbHisBreweryDeliveryVolumeRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbHisBreweryDeliveryVolume, int>
    {
        public EfCoreTbHisBreweryDeliveryVolumeRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbHisBreweryDeliveryVolume>> GetListAsync(
            string? filterText = null,
            bool? isSendMail = null,
            DateTime? dateSendMailMin = null,
            DateTime? dateSendMailMax = null,
        ...
        protected virtual IQueryable<TbHisBreweryDeliveryVolume> ApplyFilter(
            IQueryable<TbHisBreweryDeliveryVolume> query,
            string? filterText = null,
            bool? isSendMail = null,
            DateTime? dateSendMailMin = null,
            DateTime? dateSendMailMax = null,
