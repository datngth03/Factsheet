...
{
    public abstract class EfCoreTbFileUploadRepositoryBase : EfCoreRepository<Sabeco_FactsheetDbContext, TbFileUpload, int>
    {
        public EfCoreTbFileUploadRepositoryBase(IDbContextProvider<Sabeco_FactsheetDbContext> dbContextProvider)
        ...
        public virtual async Task<List<TbFileUpload>> GetListAsync(
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            int? personIdMin = null,
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            query = query.OrderBy(string.IsNullOrWhiteSpace(sorting) ? TbFileUploadConsts.GetDefaultSorting(false) : sorting);
        ...
        protected virtual IQueryable<TbFileUpload> ApplyFilter(
            IQueryable<TbFileUpload> query,
            string? filterText = null,
            int? companyIdMin = null,
            int? companyIdMax = null,
            int? personIdMin = null,
