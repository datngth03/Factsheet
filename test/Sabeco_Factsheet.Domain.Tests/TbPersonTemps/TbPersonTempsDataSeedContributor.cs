...
{
    public class TbPersonTempsDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ITbPersonTempRepository _tbPersonTempRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public TbPersonTempsDataSeedContributor(ITbPersonTempRepository tbPersonTempRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _tbPersonTempRepository.InsertAsync(new TbPersonTemp
            (
                idPerson: 36064210,
                ...
                iDCardDate: new DateTime(2014, 11, 27),
            ...
            (
                ...
                iDCardDate: new DateTime(2019, 9, 15),
