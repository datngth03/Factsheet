...
{
    public abstract class GetTbCompanyPersonsInputBase : PagedAndSortedResultRequestDto
    {
        ...
        public byte? PostionTypeMin { get; set; }
        public byte? PostionTypeMax { get; set; }
        ...
        public GetTbCompanyPersonsInputBase()
        {
