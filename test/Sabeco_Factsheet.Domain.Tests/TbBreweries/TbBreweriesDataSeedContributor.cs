...
{
    public class TbBreweriesDataSeedContributor : IDataSeedContributor, ISingletonDependency
    {
        private bool IsSeeded = false;
        private readonly ITbBreweryRepository _tbBreweryRepository;
        private readonly IUnitOfWorkManager _unitOfWorkManager;

        public TbBreweriesDataSeedContributor(ITbBreweryRepository tbBreweryRepository, IUnitOfWorkManager unitOfWorkManager)
        {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            await _tbBreweryRepository.InsertAsync(new TbBrewery
            (
                ...
                companyId: 96552469,
                capacityVolume: 1033130929,
                deliveryVolume: 2802597,
            ...
            (
                ...
                companyId: 2051093966,
                capacityVolume: 1693039401,
                deliveryVolume: 519592471,
