...
namespace Sabeco_Factsheet.EntityFrameworkCore.Domains.TbCompanies
{
    public class TbCompanyRepositoryTests : Sabeco_FactsheetEntityFrameworkCoreTestBase
    {
        private readonly ITbCompanyRepository _tbCompanyRepository;

        public TbCompanyRepositoryTests()
        {
            _tbCompanyRepository = GetRequiredService<ITbCompanyRepository>();
        }
        ...
        public async Task GetListAsync()
        {
            ...
            {
                // Act
                var result = await _tbCompanyRepository.GetListAsync(
                    isGroup: true,
        ...
        public async Task GetCountAsync()
        {
            ...
            {
                // Act
                var result = await _tbCompanyRepository.GetCountAsync(
                    isGroup: true,
